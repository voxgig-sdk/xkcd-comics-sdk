...
|---|---|---|
| `ts/` | @voxgig-sdk/xkcd-comics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/xkcd-comics-sdk \
      --repository voxgig-sdk/xkcd-comics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/xkcd-comics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/xkcd-comics-sdk --id=<id>` removes it.
