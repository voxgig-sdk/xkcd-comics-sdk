...
// XkcdComics SDK idempotency feature
...
class XkcdComicsIdempotencyFeature extends XkcdComicsBaseFeature
{
    ...
    private function _mutating(XkcdComicsContext $ctx): bool
    {
