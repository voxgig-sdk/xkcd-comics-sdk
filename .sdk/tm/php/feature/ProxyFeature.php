...
class XkcdComicsProxyFeature extends XkcdComicsBaseFeature
{
    ...
    public function init(XkcdComicsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (XkcdComicsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
