...
// XkcdComics SDK ratelimit feature
...
class XkcdComicsRatelimitFeature extends XkcdComicsBaseFeature
{
    ...
    private function _acquire(XkcdComicsContext $ctx): void
    {
    ...
    private function _track(XkcdComicsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
