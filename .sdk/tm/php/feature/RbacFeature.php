...
class XkcdComicsRbacFeature extends XkcdComicsBaseFeature
{
    ...
    private function _required(XkcdComicsContext $ctx): ?string
    {
    ...
    private function _reject(XkcdComicsContext $ctx, string $required): void
    {
    ...
    private function _track(XkcdComicsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
