...
// XkcdComics SDK streaming feature
...
class XkcdComicsStreamingFeature extends XkcdComicsBaseFeature
{
    ...
    private function _iterate(XkcdComicsResult $result): \Generator
    {
    ...
    private function _streamable(XkcdComicsContext $ctx): bool
    {
