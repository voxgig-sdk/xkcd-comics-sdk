...
// XkcdComics SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class XkcdComicsTestFeature extends XkcdComicsBaseFeature
{
    ...
    public function init(XkcdComicsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (XkcdComicsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = XkcdComicsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (XkcdComicsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(XkcdComicsContext $ctx, $op, $args): array
    {
