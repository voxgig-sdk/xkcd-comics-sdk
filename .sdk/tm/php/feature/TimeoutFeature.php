...
// XkcdComics SDK timeout feature
...
class XkcdComicsTimeoutFeature extends XkcdComicsBaseFeature
{
    ...
    private function _with_timeout(XkcdComicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(XkcdComicsContext $_ctx, float $ms): void
    {
        $client = $this->client;
