...
// XkcdComics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = XkcdComicsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(XkcdComicsOmni::structfix($now, Struct::undef()))
                        !== json_encode(XkcdComicsOmni::structfix($val, Struct::undef()))) {
