...
// XkcdComics SDK utility: fetcher

class XkcdComicsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; XkcdComicsSDK/1.0)';
    ...
    public static function call(XkcdComicsContext $ctx, string $fullurl, array $fetchdef): array
    {
