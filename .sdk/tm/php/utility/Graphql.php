...
// XkcdComics SDK utility: graphql
//
...
class XkcdComicsGraphql
{
    ...
    // equivalent.
    public static function body(XkcdComicsContext $ctx): mixed
    {
    ...
    public static function errors(XkcdComicsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
