...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import XkcdComicsContext
        ctx = XkcdComicsContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, XkcdComicsError):
        errmsg = err.msg
    ...
    sdk_err = XkcdComicsError("", msg, ctx)
