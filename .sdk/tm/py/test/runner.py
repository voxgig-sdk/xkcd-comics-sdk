...
class XkcdComicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XkcdComicsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = XkcdComicsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = XkcdComicsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
