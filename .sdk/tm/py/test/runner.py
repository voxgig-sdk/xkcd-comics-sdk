...
class XkcdComicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XkcdComicsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = XkcdComicsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = XkcdComicsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
