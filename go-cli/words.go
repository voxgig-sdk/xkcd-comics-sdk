...
func registerSDKWords(r *eng.Registry, client *sdk.XkcdComicsSDK) {
...
func runOp(client *sdk.XkcdComicsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
