// Command XkcdComics-mcp is an MCP server exposing the XkcdComics
// SDK as MCP tools.
//
// Two tools are registered:
//
//	XkcdComics_list  — list records of an entity
//	XkcdComics_load  — load a single record of an entity
//
