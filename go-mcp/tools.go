...
type Args struct {
	Entity string         `json:"entity" jsonschema:"info0"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.XkcdComicsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "xkcd-comics_list",
		Description: "List records from XkcdComics. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "xkcd-comics_load",
		Description: "Load a single record from XkcdComics. " +
...
func runOp(client *sdk.XkcdComicsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.XkcdComicsSDK, name string) (sdk.XkcdComicsEntity, error) {
	switch strings.ToLower(name) {
	case "info0":
		return client.Info0(nil), nil
