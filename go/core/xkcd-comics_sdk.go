...
func (sdk *XkcdComicsSDK) OptionsMap() map[string]any {
...
func (sdk *XkcdComicsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *XkcdComicsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *XkcdComicsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *XkcdComicsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *XkcdComicsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *XkcdComicsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("XkcdComicsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *XkcdComicsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *XkcdComicsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("XkcdComicsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
