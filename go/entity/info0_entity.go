...
func NewInfo0Entity(client *core.XkcdComicsSDK, entopts map[string]any) *Info0Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Info0Entity) GetName() string { return e.name }
...
func (e *Info0Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Info0Entity) Deleted() bool {
	return e.deleted
}


func (e *Info0Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInfo0Entity(e.client, opts)
}

func (e *Info0Entity) Data(args ...any) any {
...
func (e *Info0Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *Info0Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Info0Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Info0Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Info0Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Info0Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Info0Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
