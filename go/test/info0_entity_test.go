...
func TestInfo0Entity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		info0Ref01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.info0")))
...
func info0BasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("XKCD_COMICS_TEST_INFO0_ENTID")
	...
	idmapResolved := core.ToMapAny(env["XKCD_COMICS_TEST_INFO0_ENTID"])
