...
describe("Info0Direct", function()
  it("should direct-load-info0", function()
    local setup = info0_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-info0", setup.live and "live" or "unit")
