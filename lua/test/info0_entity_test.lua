...
describe("Info0Entity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set XKCD_COMICS_TEST_INFO0_ENTID JSON to run live")
      return
    end
...
function info0_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("XKCD_COMICS_TEST_INFO0_ENTID")
  ...
  if env["XKCD_COMICS_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["XKCD_COMICS_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
