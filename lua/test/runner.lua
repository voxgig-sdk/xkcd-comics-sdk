...
function runner.env_override(m)
  local live = runner.getenv("XKCD_COMICS_TEST_LIVE")
  local override = runner.getenv("XKCD_COMICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("XKCD_COMICS_TEST_EXPLAIN")
