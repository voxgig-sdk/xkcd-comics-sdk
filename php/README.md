...
The PHP SDK for the XkcdComics API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Info0(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->XkcdComics(null)->load(
    ["id" => "test01"], null
);
