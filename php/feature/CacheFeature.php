...
class XkcdComicsCacheFeature extends XkcdComicsBaseFeature
{
    ...
    private function _through(XkcdComicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
