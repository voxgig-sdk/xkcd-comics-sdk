...
// XkcdComics SDK clienttrack feature
...
class XkcdComicsClienttrackFeature extends XkcdComicsBaseFeature
{
    ...
    public function PostConstruct(XkcdComicsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'XkcdComics-SDK';
