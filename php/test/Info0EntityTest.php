...
class Info0EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set XKCDCOMICS_TEST_INFO__ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function info0_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("XKCDCOMICS_TEST_INFO__ENTID");
