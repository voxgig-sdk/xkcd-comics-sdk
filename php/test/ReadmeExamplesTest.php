...
// XkcdComics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (XkcdComicsSDK::test)
...
{
    private const SDK_CLASS = 'XkcdComicsSDK';
    ...
    private const SDK_BASE = 'xkcdcomics_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../xkcdcomics_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
