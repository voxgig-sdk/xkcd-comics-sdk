...
// XkcdComics SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class XkcdComicsMakeRequest
{
    public static function call(XkcdComicsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new XkcdComicsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new XkcdComicsResponse($fetched);
        } else {
