...
// XkcdComics SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class XkcdComicsTransformResponse
{
    public static function call(XkcdComicsContext $ctx): mixed
    {
        ...
        $transform = XkcdComicsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
