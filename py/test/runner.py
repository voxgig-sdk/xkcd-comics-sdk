...
class XkcdComicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = XkcdComicsTestRunner.getenv("XKCDCOMICS_TEST_LIVE")
        override = XkcdComicsTestRunner.getenv("XKCDCOMICS_TEST_OVERRIDE")
        ...
        explain = XkcdComicsTestRunner.getenv("XKCDCOMICS_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["XKCDCOMICS_TEST_EXPLAIN"] = explain
