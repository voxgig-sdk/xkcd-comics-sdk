# XkcdComics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions XkcdComicsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both XkcdComicsSDK(...) and XkcdComicsSDK.test(...) become
#      XkcdComicsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "xkcdcomics_sdk"
_SDK_CLASS = "XkcdComicsSDK"
