...
from xkcdcomics_sdk.utility import register

# Load features
from xkcdcomics_sdk.feature.base_feature import XkcdComicsBaseFeature
from xkcdcomics_sdk.features import _has_feature, _make_feature
...
class XkcdComicsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = XkcdComicsUtility()
        self._utility = utility

        from xkcdcomics_sdk.config import shared_config
    ...
    def get_utility(self):
        return XkcdComicsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("XkcdComicsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Info0(self, data=None) -> "Info0Entity":
        ...
        from xkcdcomics_sdk.entity.info0_entity import Info0Entity
