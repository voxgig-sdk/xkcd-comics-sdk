...
(0, node_test_1.describe)('Info0Direct', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.XkcdComicsSDK({
    ...
    (0, node_test_1.test)('direct-load-info0', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-info0', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.XKCD_COMICS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.XkcdComicsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['XKCD_COMICS_TEST_INFO0_ENTID'];
    ...
    const client = new __1.XkcdComicsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=Info0Direct.test.js.map