...
function envOverride(m) {
    if ('TRUE' === process.env.XKCD_COMICS_TEST_LIVE ||
        'TRUE' === process.env.XKCD_COMICS_TEST_OVERRIDE) {
    ...
    m.XKCD_COMICS_TEST_EXPLAIN = process.env.XKCD_COMICS_TEST_EXPLAIN || m.XKCD_COMICS_TEST_EXPLAIN;
    return m;
}
